// Get your shorts on - this is an array workout!
    ...
    const inventors = [
      ...
      //another solution - done in one line
      ...
      //todo 4. How many years did all the inventors live all together?
      ...
      //another solution with fewer lines turnery operator
      // const yearsLived = inventors.sort(function(a, b) {
      //   const lastGuy = a.passed - a.year;
      //   const nextGuy = b.passed - b.year;
      ...
      // const links = Array.from(category.querySelectorAll('a')); //could also use the spread operator to turn into an array [...category.querySelectorAll('a')]
      // const de = links
